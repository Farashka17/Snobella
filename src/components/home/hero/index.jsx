  ...
  return (
    <div className="bg-[#FFE2E0] ">
      <div className="container max-w-[1128px]  flex justify-between items-center mx-auto py-[25px] ">
       ...
       <Link to="/productlist"><button className="py-3 px-[57px] font-medium text-[16px] text-[#FFFFFF]  border-0 rounded-[8px] shadow-md bg-[#206363] mt-12">Shop now</button></Link>  
        </div>
        {/* sag */}
        <div>
          <img src={HeroBags}/>
